  ...
  return (
    <div className="bg-[#efefed]">
      ...
      <section className="px-4 pt-10 sm:px-6 md:px-10 md:pt-12">
        <FadeIn className="mx-auto grid w-full max-w-8xl gap-4 md:grid-cols-[0.9fr_1.15fr_0.8fr] md:items-center md:gap-6">
          <div className="flex justify-center">
            <div className="relative h-[300px] w-full overflow-hidden sm:h-[380px] md:h-[520px] lg:h-[560px]">
              <Image
          ...
          <div className="flex justify-center">
            <div className="relative h-[420px] w-full overflow-hidden sm:h-[560px] md:h-[700px] lg:h-[760px]">
              <Image
          ...
          <div className="flex justify-center">
            <div className="relative h-[280px] w-full overflow-hidden sm:h-[360px] md:h-[500px] lg:h-[540px]">
              <Image
      ...
      <section className="px-4 py-14 sm:px-6 md:px-10 md:py-20">
        <FadeIn className="mx-auto grid w-full max-w-8xl gap-8 md:grid-cols-[1.2fr_0.9fr] md:items-end">
      ...
      <section className="relative overflow-hidden px-4 py-14 sm:px-6 md:px-10 md:py-16">
        ...
        <div className="relative mx-auto w-full max-w-3xl bg-white/20 p-5 backdrop-blur-md sm:p-7 md:p-10">
